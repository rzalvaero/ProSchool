...
function gen_menu() {
	...
	if ($sess_level == "guru") {
	  $menu = array(
	            ...
	            array("icon"=>"question-circle", "url"=>"m_soal", "text"=>"Soal"),
				array("icon"=>"book", "url"=>"m_paket", "text"=>"Paket Soal"),
	            array("icon"=>"edit", "url"=>"m_ujian", "text"=>"Ujian"),
	  ...
	  $menu = array(
	            ...
	            array("icon"=>"users", "url"=>"m_guru", "text"=>"Data Guru"),
	            array("icon"=>"tags", "url"=>"m_mapel", "text"=>"Data Mapel"),
	...
	if ($menu != null) {
		...
		<div class="col-lg-12 row">
		  <div class="panel panel-default">
		    ...
		    foreach ($menu as $m) {
		        if ($url == $m['url']) {
		          echo '<a href="'.base_url().$m['url'].'" class="btn btn-sq btn-warning"><i class="fa fa-'.$m['icon'].' fa-5x"></i><br><br/>'.$m['text'].' </a>';
		        } else {
		          echo '<a href="'.base_url().$m['url'].'" class="btn btn-sq btn-primary"><i class="fa fa-'.$m['icon'].' fa-5x"></i><br><br/>'.$m['text'].' </a>';
		        }
		    }
