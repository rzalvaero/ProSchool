...
//		query getAll model
	...
	public function kas_masuk_add()
	{
//		query getAll model
		$data['page']  	= 'kasmasukadd';
		$this->load->view('template',$data);
	}
...
//		kas biaya
		...
		foreach ($akun_id as $key => $val) {
			...
			$result[] = array(
				...
				'deskripsi'		=> 'Kas Masuk'.$unitselect->nama.'-'.$unitselectbeban->kode_akun.'-'.$unitselectbeban->keterangan.'-'.$keterangan,
				'credit'		=> $nominal[$key],
				'status'		=> 'masuk',
				'jenis'		    => 'masuk',
