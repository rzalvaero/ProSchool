			...
			<div class="card-body">
				<div class="heading-layout1">
					<div class="item-title">
						<!--						<h3>Daftar Pajak</h3>-->
						<button type="button" class="btn-fill-sm" style="background-color: orange;color: white"
								data-toggle="modal" data-target="#addItem"><i class="fa fa-plus"></i> Tambah Akun Pendapatan
						</button>
					...
					<table class="table table-hover table display data-table text-nowrap">
						<thead>
						<tr>
							<th>No</th>
							<th>Kode Akun</th>
							...
							<td>
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										...
										<a class="dropdown-item"
										   href="#delModalDebit16" data-toggle="modal"><i
						...
						<div class="modal modal-default fade" id="delModalDebit16">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<form action="https://demo.adminsekolah.net/manage/item/delete_debit/16" method="post" accept-charset="utf-8">
					...
					<div class="heading-layout1">
						<div class="item-title">
							<!--						<h3>Daftar Pajak</h3>-->
							<button type="button" class="btn-fill-sm" style="background-color: darkblue;color: white"
									data-toggle="modal" data-target="#addTax"><i class="fa fa-plus"></i> Tambah Akun Beban
							</button>
					...
					<table class="table table-hover table display data-table text-nowrap">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item"
										   href=""><i
													class="fas fa-cogs text-dark-pastel-green"></i>Edit</a>-->
										<a class="dropdown-item"
										   href="#delModalKredit9" data-toggle="modal"><i
													class="fas fa-times text-orange-red" data-toggle="tooltip"
													title="Hapus"></i>Hapus</a>
						...
						<div class="modal modal-default fade" id="delModalKredit9">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h3 class="modal-title"><span class="fa fa-warning"></span> Konfirmasi penghapusan</h3>
									...
									<div class="modal-footer">
										<form action="https://demo.adminsekolah.net/manage/item/delete_kredit/9" method="post" accept-charset="utf-8">
											<input type="hidden" name="item_id" value="2">
											<button type="button" class="btn btn-default pull-left" data-dismiss="modal"><span class="fa fa-close"></span> Batal</button>
											<button type="submit" class="btn btn-danger"><span class="fa fa-check"></span> Hapus</button>
										</form>													</div>
				...
				<div class="item-title">
					<!--						<h3>Daftar Pajak</h3>-->
					<a href="<?php echo base_url();?>keuangan/unit_pos" class="btn btn-fill-sm" style="background-color: red;color: white"
