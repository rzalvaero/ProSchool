	...
	<div class="col-8-xxxl col-12">
		<div class="card">
			<div class="card-body">
				...
				<form class="new-added-form" action="<?php echo base_url(). 'keuangan/tarif_unit_pos_save_beban'; ?>" method="post">
					<div class="row">
						<!--							input hidden value id_unit_pos-->
						<input type="hidden" name="id_unit_pos" value="<?= $list->id_unit_pos ?>">
						<input type="hidden" name="tipe" value="beban">
						<div class="col-12-xxxl col-lg-6 col-12 form-group">
							<label>Tambah Beban</label>
...
<!--						query-->
						<?php
						$db = $this->db->query("SELECT * FROM sr_tarif_unit_pos join sr_account on sr_account.id_akun = sr_tarif_unit_pos.id_kode_akun where tipe = 'beban'")->result();
						?>
					...
					<form class="new-added-form" action="<?php echo base_url(). 'keuangan/tarif_unit_pos_save_beban'; ?>" method="post">
						<div class="row">
							...
							<div class="col-12-xxxl col-lg-6 col-12 form-group">
								...
								?>
								<select name="unit" class="select2" name="unit">
									<option value="">Pilih Unit</option>
									<?php foreach ($db as $unit) { ?>
