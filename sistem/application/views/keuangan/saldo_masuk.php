...
<!--						button right-->
						<div class="dropdown">
							<a href="<?php echo base_url(); ?>kasmasuk/kas_masuk_add"class="btn btn-fill-lg btn-gradient-yellow">Tambah Kas Masuk</a>
						</div>
					...
					<div class="table-responsive">
						...
						<table id="dtable" class="table table-hover  display data-table text-nowrap">
							...
							<?php
							$no = 1;
							$db = $this->db->query("SELECT * FROM sr_invoice_body WHERE status = 'masuk'")->result();
							foreach ($db as $item):
								?>
								<tr>
									<td><?=$no++ ?></td>
