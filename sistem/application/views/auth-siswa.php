...
<head>
    ...
    <title><?php echo $row['title'] ?> | Login Siswa</title>
            ...
            <div class="login-box">
                ...
                <form class="login-form" action="<?php echo base_url();?>auth/login_akses" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" placeholder="Masukan NISN" class="form-control">
                        <i class="far fa-envelope"></i>
                    </div>
                    <div class="form-group">
                        <label>Kata Sandi</label>
                        <input type="password" name="password" placeholder="Masukan Kata Sandi" class="form-password form-control">
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between">
                        ...
                        <a href="<?php echo base_url();?>auth/guru" class="forgot-btn">Masuk Guru ?</a>
                    </div>
                    <div class="form-group">
