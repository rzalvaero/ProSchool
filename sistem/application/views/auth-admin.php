...
<head>
    ...
    <title><?php echo $row['title'] ?> | Login Admin</title>
    ...
    <div class="login-page-wrap">
        <div class="login-page-content">
            <div class="login-box">
                ...
                <form class="login-form" action="<?php echo base_url();?>admin/login_akses" method="POST">
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between">
                        ...
                        <a href="#" class="forgot-btn">Login Admin</a>
                    </div>
                    <div class="form-group">
