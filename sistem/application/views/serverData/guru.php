    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        <input type="number" name="nbm" value="" class="form-control" id="nbm" placeholder="NIP Guru">
                    </div>
                </div>
				...
				<div class="col-lg-3">                                      
					<div class="form-group">
                    <a style="text-align:center;margin: 0px 20px 0px 0px;" href="<?php echo base_url();?>guru/add" id="btn-filter" class="fw-btn-fill btn-gradient-yellow">Tambah Guru</a>
                    </div>
				</div>
            </div>
            </form>
