<div class="card height-auto">
    <div class="card-body">
        ...
        <form class="mg-b-20" action="<?php echo base_url(); ?>nilai/leger_print" method="POST" target="_blank">
            <div class="row gutters-8">
                <div class="col-6-xxxl col-xl-6 col-lg-6 col-12 form-group">
                    <!-- <input type="text" placeholder="Search by Class..." class="form-control"> -->
                    <select class="select2" name="kelas" onchange="window.open(this.options[this.selectedIndex].value);">
