                        ...
                        <table id="tPengetahuan" class="table display data-table text-nowrap">
                            <thead style="background-color:#042954;">
                                <tr>
                                    ...
                                    <th style="color: #fff;">Nilai Harian <i class="float-right" style="font-size:10px;">(* jika penilaian sudah cukup dan masih ada kolom tersisa, silahkan input angka 1 untuk melewati penilaian)</i></th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="card height-auto">
                <div class="card body" id="divUtsuas" style="display:none;">
                    ...
                    <div class="card-body table-responsive">
                        <div class="float-right"><small><i>* jika ada nama siswa anda yang tidak ada dalam daftar, silahkan klik tambah data atau reset data pada bagian bawah tabel</i></small></div>
                        <table id="tUtsuas" class="table display data-table text-nowrap">
                            <thead style="background-color:#042954;">
                                <tr>
                                    <th style="color: #fff;">No</th>
                                    <th style="color: #fff;">Nama Siswa</th>
                                    <th style="color: #fff;">Nilai UTS</th>
                                    <th style="color: #fff;">Nilai UAS</th>
                                </tr>
                            </thead>
                            <tbody>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" data-dismiss="modal">Tutup</button>
                <button type="submit" class="btn-fill-lg bg-blue-dark btn-hover-yellow" id="btn-tambah-siswa">Simpan</button>
            </div>
            </form>
        </div> 
    </div>
