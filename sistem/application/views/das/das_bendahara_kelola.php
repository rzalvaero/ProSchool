        ...
        <div class="animated lightSpeedIn col-md-12">
            <div class="card card-info card-outline">
              <div class="card-header">
               ...
               <a class="btn bg-red btn-sm" href="<?php echo base_url(); ?>das/das_user_bendahara/<?php echo $id_das_bendahara; ?>"><i class="fa fa-arrow-left"> </i> Kembali</a>
                ...
                <a class="btn bg-navy btn-sm" href="#" data-toggle="modal" data-target="#modalAdd"><i class="fa fa-plus"> </i> Tambah Data</a>
                        <?php } else { ?>
                            <br>
                            <span class="btn btn-xs btn-flat bg-warning"><i class="far fa-engine-warning"></i> Dana Anggaran Sudah Di Tutup</span>
                        <?php } ?>
                    </div>
                ...
                <table class="table">
                  ...
                  <table id="datatb" class="table table-bordered table-hover table-striped">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($das_bendahara_kelola->result_array() as $data) { ?>
                                    <tr>
                                        <td><?php echo $no; ?></td>
                                        ...
                                        <td>
                                        <?php if ($status == 0 && $status_das_user == 0) { ?>    
                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url().'das/das_user_bendahara_kelola_hapus/'.$data['id_das_user_bendahara_output'].'/'.$data['id_das_user_bendahara']; ?>"><i class="fa fa-trash"> </i></a>
                                        <?php } ?>
                                        <td>
                                    </tr>
                                <?php $no++;
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div id="info"></div>
            <form role="form" action="<?php echo base_url(); ?>das/das_bendahara_kelola_save" method="post">
                    <input class="id_das_user_bendahara" type="hidden" name="id_das_user_bendahara" value="<?php echo $id_das_user_bendahara; ?>" readonly>
