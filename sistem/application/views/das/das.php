...
//                      $total = $this->db->query("SELECT SUM(sisa_saldo) as hitung, SUM(total_terima) as hitung_terima FROM das_user WHERE id_das_kategori = '$data[id_das_kategori]'")->row();
                        ...
                        <td style="text-align:center;">
                          <?php if ($data['dana'] == 0) { ?>
                            <div class="btn-group btn-group-sm">
                              <a class="btn bg-navy btn-xs" href="<?php echo base_url() . 'das/das_tutup/' . $data['id_das_kategori']; ?>" onclick="return confirm('Yakin ingin menutup DAS ini ?');"><i class="fad fa-lock-alt"></i> Tutup</a>
                              <a class="btn bg-warning btn-xs" href="<?php echo base_url() . 'das/das_user/' . $data['id_das_kategori']; ?>"><i class="fab fa-elementor"></i> Kelola</a>
                              <a class="btn btn-danger btn-xs" href="<?php echo base_url() . 'das/das_hapus/' . $data['id_das_kategori']; ?>"><i class="fas fa-trash-alt"></i> Hapus</a>
                            <?php } else { ?>
                              <a class="btn btn-primary btn-xs" href="<?php echo base_url() . 'das/das_user/' . $data['id_das_kategori']; ?>"><i class="fa fa-list-alt"> </i> Detail</a>
                            <?php } ?>
