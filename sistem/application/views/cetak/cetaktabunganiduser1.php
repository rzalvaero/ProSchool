...
<table class="table" cellpadding="5" cellspacing="0">
	...
	<tr>
		...
		<th class="th" style="text-align:left;">Saldo</th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	<tr>
		...
		<td class="tf" style="text-align:left;"><?= $item->debet?></td>
		<td class="tf" style="text-align:right;"><?= $item->credit?></td>
		<td class="tf" style="text-align:right;"><?= $item->saldo?></td>
	</tr>
	<?php endforeach; ?>
