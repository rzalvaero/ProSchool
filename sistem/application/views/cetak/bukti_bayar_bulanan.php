...
join sr_pos_pembayaran on sr_pos_pembayaran.id_pos = sr_jenis_bayar.id_pos  WHERE id_pembayaran_bulanan = '$id_pembayaran_bulanan'")->row();
        ?>
        <table>
            <tr>
                <td>Tanggal </td>
    ...
    <table class="table" cellpadding="5" cellspacing="0">
        ...
        <tbody>
            <tr>
                <td><?php echo $pembayaran_bulanan->nama_pos . ' - ' . $pembayaran_bulanan->tingkat . ' - ' . $pembayaran_bulanan->bulan; ?></td>
