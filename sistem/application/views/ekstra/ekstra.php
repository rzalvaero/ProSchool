		...
		<div class="col-4-xxxl col-12">
			<div class="card height-auto">
				<div class="card-body" >
					...
					<form class="new-added-form" action="<?php echo base_url(). 'ekstra/save_ektra'; ?>" method="post">
						<div class="row">
...
<!--								sesssion unit-->
								...
								<input type="text" placeholder="Tulis Nama Ekstra" name="e_nama" class="form-control">
							</div>
				...
				<div class="card-body">
					...
					<div class="table-responsive">
						<table id="dtable" class="">
							...
							$row_siswa = $this->db->query("select * from sr_ekstra where unit = '$unit'")->result();
							...
							<?php foreach ($row_siswa as $product): ?>
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item"
												   href="#editModal<?php echo $product->idekstra;?>" data-toggle="modal"><i
								...
								<div class="modal fade" id="delModal3" role="dialog">
									<div class="modal-dialog modal-md">
										<div class="modal-content">
											...
											<form class="form-horizontal" method="post" action="<?php echo base_url('ekstra/delete_ekstra') ?>">
												<div class="modal-body">
													<p>Anda yakin mau menghapus <b><?php echo $product->e_nama;?></b></p>
												</div>
												<div class="modal-footer">
													<input type="hidden" name="idekstra" value="<?php echo $product->idekstra;?>">
								...
								<div class="modal fade" id="editModal<?php echo $product->idekstra;?>" role="dialog">
									<div class="modal-dialog modal-md">
										<div class="modal-content">
											<div class="modal-header">
												<h2>Edit Ekstra</h2>
											...
											<form class="form-horizontal" method="post" action="<?php echo base_url('ekstra/setting_ekstra_update') ?>">
												<div class="modal-body">
													<div class="row">
														<div class="col-12-xxxl col-lg-6 col-12 form-group">
															<label>Nama Ekstra</label>
															<input type="text" placeholder="Tulis Nama Ekstra" name="e_nama" class="form-control" value="<?php echo $product->e_nama;?>">
														</div>
