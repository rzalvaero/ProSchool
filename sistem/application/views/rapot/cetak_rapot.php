	...
	<table width="100%">
		...
		<tr>
		 ...
		 <?php
                            ...
                            ?>
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl"><?= $d->nama_sekolah; ?></td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="25%" class="tbl"><?= $d->k_tingkat; ?> (<?= $d->k_keterangan; ?>)</td>
		</tr>
		<tr>
			<td>Alamat Sekolah</td><td>:</td><td class="tbl"><?= $d->alamat; ?></td>
			<td>Semester</td><td>:</td><td class="tbl"><?= $d->semester; ?></td>
		</tr>
		<tr>
			<td>Nama Siswa</td><td>:</td><td class="tbl"><?= $d->s_nama; ?></td>
			<td>Tahun Pelajaran</td><td>:</td><td class="tbl"><?= $tahun_ajaran; ?></td>
		</tr>
		<tr>
			<td>NIS / NISN</td><td>:</td><td class="tbl"><?= $d->s_nik; ?> / <?= $d->s_nisn; ?></td>
			<td colspan="3"></td>
		</tr>
		 <?php endforeach; ?>
