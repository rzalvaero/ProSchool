    ...
    <?php if($this->session->userdata('type_users')=="GURU" || $this->session->userdata('type_users')=="ADMIN"){ ?>
        ...
        <div class="card height-auto">
            <div class="card-body">
                ...
                <form class="new-added-form" action="<?php echo base_url(). 'buku/add_rak'; ?>" method="post">
                    <div class="row">
                    
                        <div class="col-12-xxxl col-lg-12 col-12 form-group">
                            <label>Rak Buku</label>
                            <input name="rak" type="text" placeholder="Input rak buku" class="form-control">
                        </div>
                                            ...
                                            <tr>
                                                <th>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label">Nama Rak</label>
                                                    </div>
                                                </th>
                                                <th></th>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"><?php echo $row['nama_rak'] ?></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="<?php echo base_url('/buku/delete_rak/'.$row['id_rak']);?>"><i
