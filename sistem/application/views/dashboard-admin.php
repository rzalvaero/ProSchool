        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>Halaman Utama Administrator</h3>
                    <ul>
                        <li>
                ...
                <div class="row gutters-20">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-content">
                                        ...
                                        <div class="item-number"><span class="counter" data-num="<?php echo $pengajar; ?>"><?php echo $pengajar; ?></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!--            <div class="col-6">-->
                    <!--                <div class="item-content">-->
                    <!--                    <div class="item-title">Unit Sekolah</div>-->
                    <!--                    <div class="item-number"><span class="counter" data-num="<?php echo $kelas; ?>"><?php echo $unit; ?></span></div>-->
                    <!--                </div>-->
                    <!--            </div>-->
                    <!--        </div>-->
                    <!--    </div>-->
