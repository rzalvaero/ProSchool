		...
		<div class="col-4-xxxl col-12">
			<div class="card height-auto">
				<div class="card-body" >
					...
					<form class="new-added-form" action="<?php echo base_url(). 'gaji/save_setting_potongan'; ?>" method="post">
						<div class="row">
							<div class="col-12-xxxl col-lg-6 col-12 form-group">
								<label>Nama Potongan</label>
								<input type="text" placeholder="Tulis Nama Potongan" name="nama_setting_potongan" class="form-control">
							</div>
							<div class="col-12-xxxl col-lg-6 col-12 form-group">
								<label>Nominal Potongan </label>
								<input type="text" placeholder="Contoh : 100000" name="nominal_setting_potongan"  class="form-control rupiah">
							</div>
					...
					<div class="table-responsive">
						<table id="dtable" class="table table-hover table display data-table text-nowrap">
							...
							<?php foreach ($list as $product): ?>
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item"
												   href="#editModal<?php echo $product->id_setting_potongan;?>" data-toggle="modal"><i
									...
									<div class="modal-dialog modal-md">
										<div class="modal-content">
											<div class="modal-header">
												<h2>Hapus Setting Potongan</h2>
												<button type="button" class="close" data-dismiss="modal">&times;</button>
											</div>
											<form class="form-horizontal" method="post" action="<?php echo base_url('gaji/delete_setting_potongan') ?>">
												<div class="modal-body">
													<p>Anda yakin mau menghapus <b><?php echo $product->nama_setting_potongan;?></b></p>
												</div>
												<div class="modal-footer">
													<input type="hidden" name="id_setting_potongan" value="<?php echo $product->id_setting_potongan;?>">
								...
								<div class="modal fade" id="editModal<?php echo $product->id_setting_potongan;?>" role="dialog">
									<div class="modal-dialog modal-md">
										<div class="modal-content">
											<div class="modal-header">
												<h2>Edit Setting Potongan</h2>
												<button type="button" class="close" data-dismiss="modal">&times;</button>
											</div>
											<form class="form-horizontal" method="post" action="<?php echo base_url('gaji/setting_potongan_update') ?>">
												<div class="modal-body">
													<div class="row">
														<input type="text" value="<?php echo $product->id_setting_potongan;?>" name="id_setting_potongan" hidden>
														<div class="col-12-xxxl col-lg-6 col-12 form-group">
															<label>Nama Potongan</label>
															<input type="text" placeholder="Tulis Nama Potongan" name="nama_setting_potongan" class="form-control" value="<?php echo $product->nama_setting_potongan;?>">
														</div>
														<div class="col-12-xxxl col-lg-6 col-12 form-group">
															<label>Nominal Potongan </label>
															<input type="text" placeholder="Contoh : 10 %" name="nominal_setting_potongan"  class="form-control" value="<?php echo $product->nominal_setting_potongan;?>">
														</div>
