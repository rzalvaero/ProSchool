                            ...
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>Data Hasil Tes</h3>
                                    </div>
                        <div class="dropdown">
                    </div>       
                  </div>
                  
         <div class="row gutters-col-lg-12 alert alert-warning" style="margin-bottom: 20px">
        <div class="col-md-6">
           <table class="table table-bordered" style="margin-bottom: 0px">
                <?php    
                    foreach ($ujian as $ujians):     
                 ?>
              <tr><td>Mata Pelajaran</td><td><?php echo $ujians->mp_nama; ?></td></tr>
              <tr><td>Nama Guru</td><td><?php echo $ujians->first_name; ?></td></tr>
              <tr><td width="30%">Nama Ujian</td><td width="70%"><?php echo $ujians->nama_ujian; ?></td></tr>
              <tr><td>Waktu</td><td><?php echo $ujians->waktu; ?> menit</td></tr>
