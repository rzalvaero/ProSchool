            ...
            <table class="table display data-table text-nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                foreach ($ujian as $d) :
                  ...
                  $nilai = '<span class="label label-warning"><i class="fa fa-minus-circle"></i> Belum ikut</span>';

                  if ($d->status == 'N' || $d->status != null) {
                    $nilai = $d->nilai;
                  }
                ?>
                  <tr>
                    ...
                    <td><?= $nilai; ?></td>
                    <td>
                      <?php if ($d->status == 'Y' || $d->status == null) { ?>
                        <a href="<?php echo base_url('/ujian/token/' . $d->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-edit" style="margin-left: 0px; color: #fff"></i> &nbsp;&nbsp;Ikuti Ujian</a>
                      <?php    } else { ?>
                        <a href="<?php echo base_url('/ujian/selesai_ujiandet/' . $d->id); ?>" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> Sudah ikut</a>
                      <?php  } ?>
                  </tr>
                <?php endforeach; ?>
              </tbody>
